# Merge videos with interval(blank image)
import argparse
import os
import time
...
def main(args):
    ...
    print(f"{len(vid_list)} videos are selected!")
...
def parse_args():
    ...
    target_dir = "/home/daton/Desktop/gs/from_aihub"
    ...
    vid_list = ["2153968", "2153997", "2154023", "2154067", "2154281", "2154480", "2154843", "2154948", "2155461", "2187562", "2187629", "2187716", "2191996", "2192004", "2192030", "2192058", "2192086", "2192188"]
